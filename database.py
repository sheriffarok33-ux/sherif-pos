...
def get_db_connection():
    """دالة لإنشاء اتصال بقاعدة البيانات (مع حماية التبديل التلقائي لضمان عدم توقف التطبيق)"""
    ...
    if db_type == "postgres" and POSTGRES_AVAILABLE and postgres_url:
        try:
            ...
            # في حال واجهت السحابة أي مشكلة في الاتصال الخارجي، نتحول تلقائياً لمحلياً ليعمل البرنامج فوراً
