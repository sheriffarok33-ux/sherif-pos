def initialize_database():
  ...
  # التأكد من إنشاء جدول purchases بكافة الأعمدة المطلوبة وتحديثه تلقائياً إذا كان قديماً
  cursor.execute("""
  ...
  # فحص وتحديث أعمدة جدول purchases لو كان الجدول منشأ مسبقاً بشكل ناقص
